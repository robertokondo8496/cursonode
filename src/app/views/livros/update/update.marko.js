...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/cursonode$1.0.0/src/app/views/livros/update/update.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Update do livro " +
    marko_escapeXml(data.id) +
    " </h1><form action=\"/edita\" method=\"post\"><input type=\"hidden\" id=\"id\" name=\"id\"" +
...
marko_template.meta = {
    id: "/cursonode$1.0.0/src/app/views/livros/update/update.marko",
    tags: [
